...
?>
    ...
    <div class="container">
        <div class="menu">
            ...
            <div class="buscador">
                    <input id="busqueda" name="buscador" type="search" placeholder="Ingresa codigo de prenda">
                                    ...
                                    .then(data => {
                                        let html = data.map(item => `
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li><a title="Editar" href="editar.php?id=${item.id}"><i class="fa-solid fa-pen-to-square"></i></a></li>
...
?>
        ...
        <td>
            <ul>
                <li><a title="Editar" href="editar.php?id=<?= $raw['id'] ?>"><i class="fa-solid fa-pen-to-square"></i></a></li>
